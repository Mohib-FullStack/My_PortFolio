...
#     print(
#         f"🟢 {'Production' if IS_RENDER else 'Development'} database connection successful!"
#     )
# except Exception as e:
#     print(f"🔴 Database connection failed: {e}")
#     if IS_RENDER:  # Only raise error in production
#         raise
...
#     except Exception as e:
#         print(f"🔴 Error in local settings: {str(e)}")
