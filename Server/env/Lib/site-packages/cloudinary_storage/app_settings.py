...
def set_credentials(user_settings):
    try:
        ...
        cloudinary.config(
            cloud_name=credentials[0], api_key=credentials[1], api_secret=credentials[2]
        )
...
INVALID_VIDEO_ERROR_MESSAGE = user_settings.get(
...
STATICFILES_MANIFEST_ROOT = user_settings.get(
    "STATICFILES_MANIFEST_ROOT", os.path.join(BASE_DIR, "manifest")
)

STATIC_IMAGES_EXTENSIONS = user_settings.get(
...
STATIC_VIDEOS_EXTENSIONS = user_settings.get(
